...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '917600630543',
    ...
    RG: process.env.RG || '917600630543',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "NoNameBot",
    BOT_NAME: process.env.BOT_NAME || 'NoName Bot',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'OM;NoName Bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
